            ...
            <table class="table table-bordered" id="datatable">
                ...
                <tr class="tr-hover">
                   ...
                   "tongDiem": "<%= objDiem.getTongDiem() %>"}'
                        ...
                        <a href="<%= request.getContextPath() %>/giangvien/diem?action=delete&maBH=<%= objDiem.getMaBD() %>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa điểm này?');">Xóa</a>
                    </td>
                </tr>
                <% } } %>
                </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="diemForm" action="${pageContext.request.contextPath}/giangvien/diem" method="post">
