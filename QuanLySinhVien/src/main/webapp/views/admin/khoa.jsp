<%@page import="com.example.quanlysinhvien.models.Khoa"%>
                ...
                <div class="modal-body">
                    <form action ="<%=request.getContextPath()%>/admin/khoa" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" class="form-control-file col-sm-8" id="exampleFormControlFile2" name="tenK">
                        </div>
                        <div class="form-group row">
                            <label for="exampleFormControlFile1" class="col-sm-3">Liên Hệ</label>
                            <textarea id="w3review" class="form-control-file col-sm-8" name="lienhe" rows="4" cols="50"></textarea>
                        </div>
